...
import jdbc.controller.EmpleadosController;
...
public class Login extends JFrame {
	...
	private EmpleadosController empleadosController = new EmpleadosController();
	...
	public Login() {
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				int confirmacion = JOptionPane.showConfirmDialog(null, "Seguro que deseas cerrar la aplcacion?");
				if (confirmacion == 0) {
					System.exit(0);
				}
			}
	...
	public void Login() {
		var usuario = this.empleadosController.verificarUsuario();
		var clave = this.empleadosController.verificarClave();
