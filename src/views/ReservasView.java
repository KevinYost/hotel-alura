...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblCheckIn.setBounds(68, 136, 226, 14);
		...
		lblTitulo.setBounds(91, 60, 250, 42);
	...
	public void calcularValor(JDateChooser txtFechaEntrada, JDateChooser txtFechaSalida) {
		if (txtFechaEntrada.getDate() != null && txtFechaSalida.getDate() != null) {
			...
			long milisegundosPorDia = 86400000;
			long diferenciaEnMilisegundos = calendarSalida.getTimeInMillis() - calendarEntrada.getTimeInMillis();

			int diasEstancia = (int) (diferenciaEnMilisegundos / milisegundosPorDia);

			double precioDiario = 5000;
			double valorReserva = precioDiario * diasEstancia;
