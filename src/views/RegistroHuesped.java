...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		labelExit_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
			...
			public void mouseExited(MouseEvent e) {
				btnexit_1.setBackground(new Color(255, 255, 255));
				labelExit_1.setForeground(SystemColor.textHighlight);
			}
		});
		...
		lblTitulo.setBounds(585, 55, 260, 42);
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (RegistroHuesped.txtNombre.toString() != null && RegistroHuesped.txtFechaN.getDate() != null) {
					guardarHuesped();
				} else {
	...
	protected void guardarHuesped() {
		...
		Huespedes nuevoHuesped = new Huespedes(idReserva, txtNombre.getText(), txtApellido.getText(),
				java.sql.Date.valueOf(fechaN), txtNacionalidad.getSelectedItem().toString(), telefono);
		huespedesController.guardar(nuevoHuesped);

		int respuesta = JOptionPane.showConfirmDialog(null,
				"Huesped " + txtNombre.getText() + " a sido agregado con exito. Su numero de reserva es: " + idReserva
						+ ". Desea agregar otro huesped?");

		switch (respuesta) {
		case JOptionPane.YES_OPTION:
//				RegistroHuesped.txtNombre.setText("");
//				RegistroHuesped.txtApellido.setText("");
//				RegistroHuesped.txtFechaN.setDate(null);;
//				RegistroHuesped.txtTelefono.setText("");

			RegistroHuesped huesped = new RegistroHuesped(nuevoHuesped.getIdReserva());
